...
ifeq ($(LAGOON_CORE_USE_HTTPS),true)
	...
	echo "Alternatively import the generated certificate './local-dev/certificates/rootCA.pem' into trusted authorities in your browser."; \
	echo "If you have mkcert installed, run: make install-ca"
endif
